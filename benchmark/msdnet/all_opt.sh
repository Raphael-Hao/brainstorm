...
rm -r saveresult/
python3 main.py  --data-root  ~/dataset/ILSVRC2012/ --data ImageNet --save /home/v-louyang/brainstorm_project/brainstorm/benchmark/msdnet/saveresult                 --arch msdnet --batch-size 256 --epochs 90 --nBlocks 5                 --stepmode even --step 4 --base 4 --nChannels 32 --growthRate 16                 --grFactor 1-2-4-4 --bnFactor 1-2-4-4                 --evalmode threshold  --evaluate-from /home/v-louyang/brainstorm_project/brainstorm/benchmark/msdnet/msdnet-step=4-block=5.pth.tar  --benchmark all_opt             --use-valid --gpu 0,1,2,3 -j 16 --init_routers --parallel
