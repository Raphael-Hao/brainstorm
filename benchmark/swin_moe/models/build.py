...
from .swin_transformer_v2_moe import SwinV2TransformerMoE, LayerNormFP32
...
def build_model(config):
    ...
    if model_type == 'swin':
        ...
        model = SwinV2TransformerMoE(img_size=config.DATA.IMG_SIZE,
                                     ...
                                     drop_rate=config.MODEL.DROP_RATE,
                                     drop_path_rate=config.MODEL.DROP_PATH_RATE,
                                     norm_layer=partial(_layer_norm,
                                                        eps=config.MODEL.SWIN_V2_MOE.LN_EPS),
