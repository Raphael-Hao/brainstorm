...
_config_dict = dict(
    ARCH_NAME="dynamic_C",
    MODEL=dict(
        WEIGHTS=str(BRT_CKPT_PATH / "dynamic_routing/dynamic_C_miou74_8.pth"),
        CAL_FLOPS=False,
        BACKBONE=dict(
    ...
    BRT=dict(
        PREDICT_MODE=True,
        GATE_HISTORY_PATH="/home/ouyang/project/brainstorm/benchmark/dynamic_routing/logs/Seg.Layer16.SmallGate.Dynamic_C/gate_history.csv",
    ),
)
