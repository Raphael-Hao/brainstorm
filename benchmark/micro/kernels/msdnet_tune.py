...
def main():
    tvm_tuner = TVMTuner()
    BRT_LOG_PATH=pathlib.Path("/home/v-weihaocui/brainstorm_project/brainstorm/.cache/log").absolute()
    conv_params_log_file = (
        BRT_LOG_PATH / "benchmark/msdnet/msdnetsave.json"
    )
    conv_params_log_file_nodup = (
        BRT_LOG_PATH / "benchmark/msdnet/msdnetsavefilter.json"
    )
