...
class classSR_3class_fused_rcan_net(nn.Module):
    def __init__(
        self, raw: classSR_3class_rcan_net, subnet_bs: Tuple[int] = (27, 50, 28)
    ):
        ...
        self.net1 = FusedRCAN(raw.net1, subnet_bs[0])
        self.net2 = FusedRCAN(raw.net2, subnet_bs[1])
        self.net3 = FusedRCAN(raw.net3, subnet_bs[2])
