...
from models.archs.classSR_rcan_arch import (
    classSR_3class_rcan_net as classSR_3class_rcan_net,
)
...
if __name__ == "__main__":
    ...
    for model_name in models:
        ...
        with open(
            BRT_CACHE_PATH / f"transformed_model/classsr/{model_name}_graph.svg", "wb"
        ) as f:
