...
LR_folder = "/home/ouyang/project/ClassSR/datasets/DIV2K_scale_sub/LR"
GT_folder = "/home/ouyang/project/ClassSR/datasets/DIV2K_scale_sub/GT"

save_list = [
    "/home/ouyang/project/ClassSR/datasets/DIV2K_scale_sub_psnr_LR_class3",
    "/home/ouyang/project/ClassSR/datasets/DIV2K_scale_sub_psnr_LR_class2",
    "/home/ouyang/project/ClassSR/datasets/DIV2K_scale_sub_psnr_LR_class1",
    "/home/ouyang/project/ClassSR/datasets/DIV2K_scale_sub_psnr_GT_class3",
    "/home/ouyang/project/ClassSR/datasets/DIV2K_scale_sub_psnr_GT_class2",
    "/home/ouyang/project/ClassSR/datasets/DIV2K_scale_sub_psnr_GT_class1",
]
for i in save_list:
    if os.path.exists(i):
        pass
...
f1 = open("/home/ouyang/project/ClassSR/codes/data_scripts/divide_train.log")
a1 = f1.readlines()
index = 0
for i in a1:
    index += 1
