...
for scale in [1, 0.9, 0.8, 0.7, 0.6]:
    GT_folder = "/home/ouyang/project/ClassSR/datasets/DIV2K_HR/DIV2K_train_HR"
    save_GT_folder = "/home/ouyang/project/ClassSR/datasets/DIV2K800_scale/GT"
    ...
    for path_GT in img_GT_list:
        ...
        if scale == 1:
            ...
            cv2.imwrite(
                os.path.join(
                    save_GT_folder, str(scale) + "_" + os.path.basename(path_GT)
                ),
                rlt_GT,
            )
