...
def main():
    ...
    if mode == "pair":
        # cut training data
        GT_folder = "/home/ouyang/project/ClassSR/datasets/DIV2K800_scale/HR/x4"  # fix to your path
        LR_folder = "/home/ouyang/project/ClassSR/datasets/DIV2K800_scale/LR/x4"  # fix to your path
        save_GT_folder = "/home/ouyang/project/ClassSR/datasets/DIV2K_scale_sub/GT"
        save_LR_folder = "/home/ouyang/project/ClassSR/datasets/DIV2K_scale_sub/LR"
        ...
        for path_GT, path_LR in zip(img_GT_list, img_LR_list):
            ...
            ), "GT width [{:d}] is not {:d}X as LR width [{:d}] for {:s}.".format(  # noqa: E501
                w_GT, scale_ratio, w_LR, path_GT
            )
            assert (
                h_GT / h_LR == scale_ratio
            ), "GT height [{:d}] is not {:d}X as LR height [{:d}] for {:s}.".format(  # noqa: E501
        ...
        opt[
            "input_folder"
        ] = "/home/ouyang/project/ClassSR/datasets/DIV2K_HR/DIV2K_valid_HR"
        opt["save_folder"] = "/home/ouyang/project/ClassSR/datasets/DIV2K_valid_sub/GT"
    ...
    for x in h_space:
        for y in w_space:
            ...
            cv2.imwrite(
                osp.join(
                    opt["save_folder"],
                    img_name.replace(".png", "_s{:03d}.png".format(index)),
                ),
                crop_img,
