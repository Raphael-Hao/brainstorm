...
_config_dict = dict(
    MODEL=dict(
        WEIGHTS="/home/whcui/checkpoints/dynamic_C_miou74_8.pth",
        CAL_FLOPS=True,
        BACKBONE=dict(
    ...
    BRT=dict(
        PREDICT_MODE=True,
        GATE_HISTORY_PATH="/home/whcui/model_logs/dl_lib_playground/Dynamic/Seg.Layer16.SmallGate.Dynamic_C/gate_history.csv",
    ),
)
