...
def hetero_make_proto_tensor_cls():
    make_proto_tensor_cls("active_blocks", [torch.zeros(0, dtype=torch.int64)])
...
class HeteroFusedScatterRouter(ScatterRouter):
    ...
    def dispatch(
        ...
        for i in range(self.dst_num):
            ...
            out_flows[i].pack(out_flow_tag, out_flow_load, active_blocks=active_blocks)
        return out_flows
