...
azcopy copy "https://projectbrainstorm.blob.core.windows.net/largedata/swin_moe_micro_bench_data/?sp=racwdli&st=2022-09-23T02:27:48Z&se=2023-02-01T10:27:48Z&spr=https&sv=2021-06-08&sr=c&sig=e%2B%2F9PGQi5%2B8g4bXsuJ14AHrk98RohKx51QFBlAWwIWg%3D" "$HOME/dataset/" --recursive
mkdir -p "$ds_ckpt_script_dir"/../../.cache/datasets
ln -s ~/dataset/imagenet22k/ "$ds_ckpt_script_dir"/../../.cache/datasets/imagenet22k
ln -s ~/dataset/swin_moe_micro_bench_data/ "$ds_ckpt_script_dir"/../../.cache/datasets/swin_moe_micro_bench_data
mkdir -p ~/ckpt
