...
python tvm_expert.py --task search --type fusion --M 40 --K 512 --N 1024 --E 16 --batch 8
...
python tvm_expert.py --task search --type fusion --M 128 --K 512 --N 1024 --E 32 --batch 16
