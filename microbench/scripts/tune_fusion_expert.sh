...
python tvm_expert.py --task search --type fusion --M 40 --K 512 --N 1024 --E 16 --batch 16 # not tunued
...
python tvm_expert.py --task search --type fusion --M 128 --K 512 --N 1024 --E 32 --batch 32 # not tunued
